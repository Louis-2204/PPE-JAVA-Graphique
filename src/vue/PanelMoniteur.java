        ...
        this.tableUser.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getClickCount() >= 2) {
                    ...
                    int retour = JOptionPane.showConfirmDialog(null, "Voulez-vous supprimer ce moniteur?",
                            "Suppression moniteur", JOptionPane.YES_NO_OPTION);
                    if (retour == 0) {
                        C_User.deleteUser(idUser);
                        C_User.deleteMoniteurInfos(idUser);
                        unTableau.deleteLigne(numLigne);
                        JOptionPane.showMessageDialog(null, "Moniteur supprimé avec succès");
                    }
                    ...
                    txtDateembauche.setText(tableUser.getValueAt(numLigne, 10).toString());
                    txtDateobtentionbafm.setText(tableUser.getValueAt(numLigne, 11).toString());
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.btnAnnuler) {
            ...
            if (this.txtNom.getText().equals("") || this.txtPrenom.getText().equals("")
                ...
                // on modifie les infos dans la table moniteur
                C_User.updateMoniteurInfos(unUser.getId_u(), dateEmbauche, dateBAFM);
